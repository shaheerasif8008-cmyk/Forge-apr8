# AGENTS.md â Forge: AI Employee Manufacturing System
...
| LLM Primary | Anthropic Codex | Primary reasoning for factory AI and employees |
...
- Anthropic Codex, OpenAI GPT-4/4o, open-weight via litellm
...
Record every significant decision in `DECISIONS.md` with: date, decision, context, alternatives, rationale. Paste relevant entries as context in new Codex sessions.
